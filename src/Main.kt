 ...
 *
 * Crear una clase que herede de Articulo y se llame Ordenador. Debe agregar a su constructor primario el tipo,
 * que será de TipoOrdenador (BASICO, OFIMATICA, TODOTERRENO, GAMING) y por defecto será BASICO.
 *
 * Sobreescribe el método promocionNavidad() para que solo aplique la promoción si el precio es superior a 500 euros.
 *
 * En el main crea dos artículos con precios 25 y 45 euros. También crea dos ordenadores, el primero GAMING de precio 1299.99
 * y el segundo un ordenador básico de 399.99 euros.
 *
